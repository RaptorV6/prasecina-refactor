...
class LPSZ {
    ...
    public function run() {
		...
		/* "SELECT * FROM mkarta_zamestnanci_hlavniprac_hier_v AS hph
			 ...
			 WHERE userm.domain_login = :login AND hie.name = 'Oddělení informatiky' " */
                                    ...
                                    <div class="card-body bg-white">
                                        <div class="table-responsive">
                                            <table id="example" style="width:100%"
                                                ...
                                                <tbody id="tbodys" class="table-striped">
                                            ...
                                            <input type="hidden" name="loginos" value="<?=$login?>">
