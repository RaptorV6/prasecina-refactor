        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center>
                    <h4 class="modal-title" id="myModalLabel">Náhled tabulky</h4>
				                <span>Založil/a:</span>  <span id="target">loading</span> <br>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <form id="editForm">
  <!-- <input type="hidden" class="id" id="neco" name="id"> -->
    ...
    .rowdata{background-color: transparent;}
            ...
            window.location.href='print.php?id=' + document.getElementById("target2").innerText;		
             ...
             function assignId(){
                window.location.href='delete_row.php?id='+document.getElementById("target2").innerText;
             }
            ...
            <div class="modal-footer">
             ...
             <a onclick="assignId()" id="zmiz"  class="btn btn-danger" style="float: left;" data-dismiss="modal"><span class="glyphicon glyphicon-trash"></span> Smazat</a>
                     
<script>			   if(document.getElementById("uzi").innerText != "Bc. Michaela Vavřincová"){
                document.getElementById("zmiz").style.visibility = "hidden"; 
             } </script>
