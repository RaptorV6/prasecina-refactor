...
class DatabaseConnector extends CustomDatabaseConnector {
    ...
    public static function getOpenPDOConnectorToAkordForPoradnikPacientu($pap) {
        return
            self::getOpenMSSQLPDOConnector(Cfg::AKORD_DB_SERVER, Cfg::AKORD_DB_NAME, Cfg::PORADNIK_PACIENTU_DB_USER, CfgPw::getDbPasswordPoradnikPacientu($pap));
    }
    
    public static function getOpenPDOConnectorToAMOSForPoradnikPacientu($pap) {
        return
            self::getOpenMSSQLPDOConnector(Cfg::AMOS_DB_SERVER, Cfg::AMOS_DB_NAME, Cfg::PORADNIK_PACIENTU_DB_USER, CfgPw::getDbPasswordPoradnikPacientu($pap));
    }
